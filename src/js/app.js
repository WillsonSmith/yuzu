...
var StarSheet_1 = __webpack_require__(3);
FontFaceOnload('Toronto Subway', {
    success: function () {
        [].slice.call(document.querySelectorAll('.top-billing')).forEach(function (node) { return node.classList.add('top-billing--fonts-loaded'); });
    },
    error: function () { },
...
var stars = new StarSheet_1["default"](canvas, numberOfStars, seed);
window.addEventListener('resize', function () {
    window.requestAnimationFrame(function () {
        stars = new StarSheet_1["default"](canvas, numberOfStars, seed);
    });
});
...
var star_1 = __webpack_require__(4);
